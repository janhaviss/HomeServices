 ...
 <div class="row">
   <div class="col-lg-12">
    ...
    <h3 id="head" class="text-center">Bookings</h3>
      <button id="btnn" type="button" onclick="window.location.href = 'bookingManagement.php';" class="btn" style="float: right; background-color:#151c48; color:white; width:150px; font-size:12px; border-radius: 12px;">Manage User Bookings</button>
