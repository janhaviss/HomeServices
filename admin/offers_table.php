...
//   $last_updated_by='admin';
  ...
  $sql = "UPDATE `offers` SET `offer_name`='$offer_name',`description`='$description',`start_date`='$start_date', `end_date`='$end_date',`discount`='$discount',`conditions`='$conditions',`availability`='$availability',`status`='$status',`created_at`=current_timestamp()),`last_updated_at`=current_timestamp()), WHERE `offers`.`offer_id` = $offer_id";
  $result = mysqli_query($conn,$sql);
  if($result){
    $update = true;
...
//   $last_updated_by='admin';
  ...
  $service_name=$_POST['service_name'];
    ...
    $sql = "INSERT INTO `offers` (`offer_id`,`offer_name`, `description`, `start_date`, `end_date`,`discount`,`conditions`, `availability`, `status`, `created_at`,`created_by`,`last_updated_by`,`service_id`) VALUES ('$offer_id','$offer_name','$description','$start_date','$end_date','$discount','$conditions','$availability','$status',current_timestamp()),'admin','admin', current_timestamp()),'$service_id')";
    $result = mysqli_query($conn,$sql);
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="offers_table.php" method="post">
  ...
  <fieldset >
      <legend>Add offer:</legend>
        ...
        <div class="row gx-3 mb-3">
            ...
            <div class="col-md-6">
            <label class="small mb-1" for="service_name">Service Name</label>
