...
echo '
<div>
      <footer class="bg-body-tertiary text-center " style="background-color:#d0c4aa">
        <!-- Grid container -->
        <div class="container p-4" style="background-color:#d0c4aa">
          <!-- Section: Images -->
          <section class="">
            <div class="row">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.05);">
          ...
          <a class="text-body" href="https://mdbootstrap.com/" style="color: #FA4364; "> OnlineHomeServices</a>
        </div>
        <!-- Copyright -->
      </footer>
</div>
