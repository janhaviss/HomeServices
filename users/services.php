...
// Debug output to check if user_id is set
...
<?php
    ...
    if($method == 'POST'){
      ...
      $sql =" INSERT INTO `comments` ( `comment_content`, `service_id`, `comment_by`, `comment_time`) VALUES ('$comment', '$id', '$user_id', current_timestamp())";
